...
Some implementations of `IFrontMatter` are provided in extension libraries, e.g. `CloudAwesome.MarkdownMaker.Docusarus` for the Docusaurus Blog, Docs and Pages APIs. See further documentation in [Platform extensions](../platform-extensions)